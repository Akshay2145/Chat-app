...
// // import { FileReaderSync} from 'filereader';
// // const AesCtr = require("../encryption/aes-ctr.js");
// // import AesCtr from "../encryption/aes-ctr.js";
...
//       // var ciphertext = reader.readAsText(newMessageRecieved.content, 'iso-8859-1');
//       // var plaintext = AesCtr.decrypt(ciphertext, 'akshay', 128);
//       // // return decrypted file as Blob; UI thread can then use saveAs()
//       // var blob = new Blob([plaintext], { type: 'application/octet-stream' });
//       // newMessageRecieved.content = blob;
//       if (
